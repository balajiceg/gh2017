...
class Dot {
  ...
  update() {
    ...
    this.x = Math.cos(ROTATION) * (this.x - center.x*10) - Math.sin(ROTATION) * (this.y - center.y) + center.x*10
    this.y = Math.sin(ROTATION) * (this.x - center.x*10) + Math.cos(ROTATION) * (this.y - center.y) + center.y
