        ...
        <div class="container">
          ...
          <div class="container">
            ...
            <div class="feature-grid">
              <div class="feature">
                <div><img src="media/image21.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                   <br />
                ...
                <div><img src="media/image22.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                  <br />
                  ...
                  <form method="POST" name="gameform" action="answer11.php"><br /><br />
