        ...
        <div class="container">
          ...
          <div class="container">
            ...
            <div class="feature-grid">
              <div class="feature">
                <div><img src="media/image27.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                   <br />
                ...
                <div><img src="media/image28.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                  <br />
                  ...
                  <form method="POST" name="gameform" action="answer14.php"><br /><br />
