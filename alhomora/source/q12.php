      ...
      <section id="two" class="wrapper style2 special">
        ...
        <div class="container">
          ...
          <header class="major special">
            <h2>Q12. Long Long Ago so Long Ago........</h2>
          ...
          <div class="container">
            ...
            <div class="feature-grid">
              <div class="feature">
                <div><img src="media/image23.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                   <br />
                ...
                <div><img src="media/image24.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                  <br />
                  ...
                  <form method="POST" name="gameform" action="answer12.php"><br /><br />
