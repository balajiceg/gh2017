      ...
      <section id="two" class="wrapper style2 special">
        ...
        <div class="container">
          ...
          <header class="major special">
            <h2>Q1.The first one is easy this time… k??</h2>
          ...
          <div class="container">
            ...
            <div class="feature-grid">
              <div class="feature">
                <div><img src="media/image1.png" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                   <br />
                ...
                <div><img src="media/image2.png" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                  <br />
                  ...
                  <form method="POST" name="gameform" action="answer1.php"><br /><br />
