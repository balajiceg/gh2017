      ...
      <section id="two" class="wrapper style2 special">
        ...
        <div class="container">
          ...
          <header class="major special">
            <h2>Q1.Do not take tonight for granted.</h2>
          ...
          <div class="container">
            ...
            <div class="feature-grid">
              <div class="feature">
                <div><img src="media/image1.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                   <br />
                ...
                <div><img src="media/image2.jpg" alt="" width="300" height="300"/></div>
                <div class="content">
                  <header>
                    <h4></h4><br />
                  <br />
